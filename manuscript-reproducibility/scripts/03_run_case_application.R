...
file.copy(file.path(root, "results_r", "table_application_results.pdf"), file.path(case_tables, "Table09_ApplicationResults.pdf"), overwrite = TRUE)
...
file.copy(file.path(case_tables, c("Table09_ApplicationResults.pdf", "Table09_ApplicationResults.csv")), file.path(root, "manuscript_outputs", "tables"), overwrite = TRUE)
